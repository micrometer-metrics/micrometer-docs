...
image::prometheus-counter-norate.png[Absolute counter value]
...
image::prometheus-counter.png[Rate-aggregated counter]
...
image::rate-normalizing.png[Behavior of a step value,width=1200]
