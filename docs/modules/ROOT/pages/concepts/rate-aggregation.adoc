...
image::implementations/prometheus-counter-norate.png[Absolute counter value]
...
image::implementations/prometheus-counter.png[Rate-aggregated counter]
...
image::implementations/rate-normalizing.png[Behavior of a step value,width=1200]
