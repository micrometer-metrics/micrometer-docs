Timers and distribution summaries can be enriched with quantiles (https://en.wikipedia.org/wiki/Quantile) computed in your app prior to shipping to a monitoring backend.
