...
-----
include::../../../samples/src/test/java/io/micrometer/docs/netty/NettyMetricsTests.java[tags=directInstrumentation,indent=0]
-----
...
[source,java,subs=+attributes]
-----
include::../../../samples/src/test/java/io/micrometer/docs/netty/NettyMetricsTests.java[tags=channelInstrumentation,indent=0]
-----
