...
As of Micrometer version 1.4.0, Micrometer supports exporting Graphite metrics using tags instead of the traditional hierarchical format, and exports metrics using the tag format by default.
