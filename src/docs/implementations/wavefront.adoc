...
image::wavefront-counter-rate.png[Wavefront-rendered counter]
...
.Timer latency.
image::wavefront-timer-latency.png[Wavefront-rendered timer]
...
.Timer throughput.
image::wavefront-timer-throughput.png[Wavefront-rendered timer throughput]
