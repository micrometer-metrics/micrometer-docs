...
.Timer latency.
image::new-relic-timer-latency.png[New Relic-rendered timer]
...
.Timer throughput.
image::new-relic-timer-throughput.png[New Relic-rendered timer throughput]
...
.Timer Percentiles.
image::new-relic-timer-percentiles.png[New Relic-rendered percentiles]
...
image::new-relic-timer-sla.png[New Relic-rendered SLO boundaries]
