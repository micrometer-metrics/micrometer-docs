...
Micrometer supports shipping metrics to Datadog directly by using its HTTP API or by using DogStatsD through the link:/src/docs/implementations/statsD.adoc[StatsD registry].
