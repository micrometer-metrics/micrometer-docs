...
image::prometheus-dashboard.png[Grafana dashboard for JVM and Tomcat binders]
...
image::prometheus-counter.png[Grafana-rendered Prometheus counter]
...
image::prometheus-counter-norate.png[Grafana-rendered Prometheus counter (no rate)]
...
image::prometheus-timer.png[Grafana-rendered Prometheus timer]
...
image::prometheus-long-task-timer.png[Grafana-rendered Prometheus long task timer]
