...
image::atlas-counter.png[Atlas-rendered counter]
...
image::atlas-timer.png[Atlas-rendered timer]
...
image::atlas-long-task-timer.png[Atlas-rendered long task timer]
