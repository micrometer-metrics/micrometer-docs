...
- Micrometer Context-Propagation https://github.com/micrometer-metrics/context-propagation/releases/tag/v1.0.2[1.0.2]
- Micrometer https://github.com/micrometer-metrics/micrometer/releases/tag/v1.10.4[1.10.4]
- Micrometer Tracing https://github.com/micrometer-metrics/tracing/releases/tag/v1.0.2[1.0.2]
