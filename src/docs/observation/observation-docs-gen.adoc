...
| Generated metrics doc file location. This can be a absolute path or relative path to the output directory.  +
Default: `_metrics.adoc`

| `--spans-output=<location>`
| Generated spans doc file location. This can be a absolute path or relative path to the output directory.  +
Default: `_spans.adoc`
| `--conventions-output=<location>`
| Generated observation convention doc file location. This can be a absolute path or relative path to the output directory.  +
