    ...
    public static void main(String[] args) {
        ...
        observationRegistry
                .observationConfig()
                    ...
                    .observationConvention(new GlobalObservationConvention());
...
class GlobalObservationConvention implements Observation.ObservationConvention<Observation.Context> {
