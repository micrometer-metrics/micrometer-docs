...
It also provides a tracing extension to Micrometer's `TimerRecordingHandler` (starting from Micrometer 2.0.0 version). Whenever a `Timer.Sample` is used, a corresponding span will be created, stared, stopped and reported.
