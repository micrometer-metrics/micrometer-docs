...
image::prometheus-guava-cache.png[Hits vs. misses,width=800]
...
image::prometheus-guava-cache-ratio.png[Hit ratio,width=800]
...
image::grafana-guava-miss-ratio.png[Miss ratio (alerted),width=800]
