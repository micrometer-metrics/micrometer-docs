...
----
# true by default
spring.metrics.web.auto-time-server-requests: false
----
...
spring.metrics.web.server-requests-name: i.want.to.be.different
----
...
spring.metrics.web.client-requests-name: i.want.to.be.different.again
----
