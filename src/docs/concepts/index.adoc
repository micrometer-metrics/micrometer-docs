...
Micrometer is _not_ a distributed tracing system or an event logger. Adrian Cole's talk on https://www.dotconferences.com/2017/04/adrian-cole-observability-3-ways-logging-metrics-tracing[Observability
3 Ways] talk does a great job of highlighting the differences between these different types of systems.
