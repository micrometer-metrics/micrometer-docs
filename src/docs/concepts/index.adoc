...
3 Ways], does a great job of highlighting the differences between these different types of systems. Micrometer does however provide the plugin mechanism that allows you to add capabilities including the tracing features. You can read more about this in the link:../docs/tracing[Micrometer Tracing documentation].
