...
To support `@MeterTag` annotation on method parameters you need to configure the `@TimedAspect` to add the `MeterAnnotationHandler`.

[source,java,subs=+attributes]
-----
include::../../../samples/src/test/java/io/micrometer/docs/metrics/TimedAspectTest.java[tags=resolvers,indent=0]

include::../../../samples/src/test/java/io/micrometer/docs/metrics/TimedAspectTest.java[tags=metrics_tag_annotation_handler,indent=0]
-----
