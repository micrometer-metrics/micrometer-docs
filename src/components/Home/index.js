        ...
        <div className="row justify-content-center" style={{ padding: 30 }}>
          <div className="col-6">
            ...
            <p>As an instrumentation facade, Micrometer allows you to instrument your code with dimensional metrics with a
              ...
              backends.</p>
          <p>
              Contains built-in support for <strong>Prometheus</strong>, Netflix <strong>Atlas</strong>,
              and <strong>Datadog</strong>. Support for InfluxDB, statsd, and Graphite are coming.</p>
          </div>
        </div>
      </div>
    </div>
