        ...
        <div className="row justify-content-center" style={{ padding: 30 }}>
          <div className="col-lg-6 col-md-12">
            ...
            <p>As an instrumentation facade, Micrometer allows you to instrument your code with dimensional metrics with
              ...
              backends.</p>
            <p>
              Contains built-in support for <strong>AppOptics</strong>, <strong>Azure Monitor</strong>, Netflix <strong>Atlas</strong>, <strong>CloudWatch</strong>, <strong>Datadog</strong>, <strong>Dynatrace</strong>, <strong>Elastic</strong>, <strong>Ganglia</strong>, <strong>Google Stackdriver</strong>, <strong>Graphite</strong>, <strong>Humio</strong>, <strong>Influx/Telegraf</strong>, <strong>JMX</strong>, <strong>KairosDB</strong>, <strong>New Relic</strong>, <strong>Prometheus</strong>, <strong>SignalFx</strong>, <strong>StatsD</strong>, and <strong>Wavefront</strong>.
            </p>
          </div>
        </div>
      </div>
