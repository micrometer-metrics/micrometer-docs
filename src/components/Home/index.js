        ...
        <div className="row justify-content-center" style={{ padding: 30 }}>
          <div className="col-lg-6 col-md-12">
            ...
            <p>As an instrumentation facade, Micrometer allows you to instrument your code with dimensional metrics with
              ...
              backends.</p>
            <p>
              Contains built-in support for <strong>Prometheus</strong>, Netflix <strong>Atlas</strong>, <strong>CloudWatch</strong>, <strong>Datadog</strong>, <strong>Graphite</strong>, <strong>Ganglia</strong>, <strong>JMX</strong>, <strong>Influx/Telegraf</strong>, <strong>StatsD</strong>, <strong>SignalFx</strong>, and <strong>Wavefront</strong>.
            </p>
          </div>
        </div>
      </div>
